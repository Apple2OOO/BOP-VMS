function onOpen(){
  SpreadsheetApp.getActiveSpreadsheet().getSheetByName('Sign-In').activate(); 
  var lastRow = SpreadsheetApp.getActiveSpreadsheet().getSheetByName('Sign-In').getLastRow();
...
function onEdit(e) {
  ...
  if(col == 1 && row > 1 && sheet.getName() == "Sign-In" && sheet.getRange(row,1).getValue() == "") {
      ...
      return;
    } else if(col == 1 && row > 1 && sheet.getName() == "Sign-In" && sheet.getRange(row,1).getValue() != "") {
   ...
   if(col == 1 && row > 1 && sheet.getName() == "Sign-In" && sheet.getRange(row,3).getValue() == "Not Registered") 
  {
...
// SECRETARY
  // ---- Enter Data
  // Check edit is in column 1, non-header row, sign-in sheet, and not blank
   if(col == 1 && row > 1 && sheet.getName() == "Secretary") {
    //Browser.msgBox('D');
